      ...
      >
        <div className="flex flex-wrap justify-center gap-4 md:gap-6 pt-6 w-full">
          ...
          <Button 
            ...
            size="lg" 
            asChild 
            className="h-12 md:h-14 text-sm md:text-base px-6 md:px-8 w-full sm:w-auto border-2 border-neon-accent/50 text-neon-accent bg-neon-accent/5 hover:bg-neon-accent/10 hover:border-neon-accent hover:text-zinc-50 hover:shadow-[0_0_20px_rgba(240,240,240,0.4)] transition-all font-mono uppercase tracking-widest"
          >
            <Link href="/game">
          ...
          <div className="flex flex-col gap-6">
             ...
             <Card className="border-neon-primary/30 bg-black/60 backdrop-blur-sm hover:border-neon-primary/50 transition-colors relative overflow-hidden group">
                ...
                <CardContent>
                  ...
                  <div className="rounded border border-neon-primary/20 bg-black/40 p-4 font-mono text-xs text-zinc-600 shadow-[0_0_10px_rgba(0,255,65,0.05)] overflow-x-auto">
